...
class MongoCxxDriver(CMakePackage):
    ...
    version(
        "3.6.3",
        sha256="8a3624f91fe85328864a09508d7678aa8c9bc0504bd236aaea6c250ff230c6a3",
    )
    version(
        "3.6.2",
    ...
    version(
        "3.4.2",
        sha256="6dc6d4ca151e3fd0e99e466b6de26078eb97cbec321f2913ba49f321de2afab3",
    )
    version(
        "3.4.1",
    ...
    version(
        "3.3.2",
        sha256="0de36003d5270997c6283478a928b4e25c7e6c10c181cf1a9cd210be5e9c65a7",
    )
    version(
        "3.3.1",
    ...
    version(
        "3.2.1",
        sha256="d5e62797cbc48c6e5e18bc0a66c14556e78871d05db4bccc295074af51b8421e",
    )
    version(
        "3.2.0",
    ...
    with when("+dots_in_keys"):
        ...
        patch("mongocxx-r362.patch", when="@3.6.2")

    def url_for_version(self, version):
        git_archive = self.git + "/archive/refs/tags/r{version}.tar.gz"
        release_url = (
            self.git
            + "/releases/download/r{version}/mongo-cxx-driver-r{version}.tar.gz"
        )
